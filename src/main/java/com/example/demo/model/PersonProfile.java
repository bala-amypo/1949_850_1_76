...
public class PersonProfile {
    ...
    private Boolean relationshipDeclared = false; // Default false [cite: 74, 204]
    private LocalDateTime createdAt = LocalDateTime.now();

    // Constructors
    public PersonProfile() {}

    public PersonProfile(String personType, String referenceId, String fullName, String email, String department) {
